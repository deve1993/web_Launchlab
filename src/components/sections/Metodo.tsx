        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 mt-20">
          ...
          <div className="flex flex-col justify-center h-[70vh]">
            ...
            <div className="relative h-64 border-l border-white/10 pl-8">
              ...
              <motion.div 
                className="absolute left-[-2px] top-0 w-1 bg-gradient-to-b from-accent to-accent-cyan rounded-full hidden md:block" 
                style={{ 
              ...
              <motion.div style={{ opacity: opacityStep1, y: yStep1 }} className="absolute inset-0 pt-4">
                <span className="inline-flex items-center mb-4 px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-widest text-accent-cyan bg-accent-cyan/10 ring-1 ring-accent-cyan/20" style={{ fontFamily: 'var(--font-mono)' }}>
                  {t('step1_timeline')}
                </span>
              ...
              <motion.div style={{ opacity: opacityStep3, y: yStep3 }} className="absolute inset-0 pt-4 pointer-events-none">
                <span className="inline-flex items-center mb-4 px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-widest text-white/80 bg-white/10 ring-1 ring-white/20 shadow-[0_0_15px_rgba(255,255,255,0.1)]" style={{ fontFamily: 'var(--font-mono)' }}>
                  {t('step3_timeline')}
                </span>
